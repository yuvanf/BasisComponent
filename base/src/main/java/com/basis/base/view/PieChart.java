...
import com.basis.base.bean.PieDataEntity;
...
public class PieChart extends View {
    ...
    private void init() {
        ...
        mTextPaint.setTextSize(DensityUtil.dip2px(getContext(),24));
...
//            }
            ...
            //提供精确的小数位四舍五入处理。
            int resToRound =(int) CalculateUtil.round(res, 2);
            ...
            if (eachMiddleAngle % 360.0 >= 90.0 && eachMiddleAngle % 360.0 <= 270.0) {
                canvas.drawLine(pxe, pye, pxe - mHorizontalLineSize-40, pye, mLinePaint);
                canvas.drawText(name, pxe - mHorizontalLineSize - 30,
                        pye + mTextOffset - getTextHeight(String.valueOf(resToRound)) + 10, mTextPaint);
                canvas.drawText(resToRound + "%", pxe - mHorizontalLineSize - 30,
                        pye + mTextOffset + getTextHeight(String.valueOf(resToRound)), mTextPaint);
            } else {
                canvas.drawLine(pxe, pye, pxe + mHorizontalLineSize+40, pye, mLinePaint);
                canvas.drawText(name, pxe + mHorizontalLineSize - mTextPaint.measureText(name) + 30,
                        pye + mTextOffset - getTextHeight(String.valueOf(resToRound)) + 10, mTextPaint);
                canvas.drawText(resToRound + "%", pxe + mHorizontalLineSize - mTextPaint.measureText(resToRound + "%") + 30,
                        pye + mTextOffset + getTextHeight(String.valueOf(resToRound)), mTextPaint);
            }
        }
    ...
    private void drawHollow(Canvas canvas) {
        ...
        if(isShowMiddleText){
            ...
            mMiddlePaint.setColor(getResources().getColor(R.color.black));
            ...
            mMiddlePaint.setColor(getResources().getColor(R.color.gray));
