package com.basis.base.view.cityPicker.view;
...
public class SideIndexBar extends View {
    ...
    private void init(Context context) {
        ...
        mTextSize = 25;//context.getResources().getDimensionPixelSize(typedValue.resourceId);

        context.getTheme().resolveAttribute(R.attr.cpIndexBarNormalTextColor, typedValue, true);
        mTextColor = context.getResources().getColor(R.color.cp_color_gray_dark);

        context.getTheme().resolveAttribute(R.attr.cpIndexBarSelectedTextColor, typedValue, true);
        mTextTouchedColor = context.getResources().getColor(R.color.color_ffd727);
