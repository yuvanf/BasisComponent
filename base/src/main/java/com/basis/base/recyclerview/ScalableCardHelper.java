...
public class ScalableCardHelper {
    ...
    private static final float STAY_SCALE =1f;
    ...
    private void pageScrolled() {
        ...
        LogUtils.d(""+leftSnapingOffset+"_"+currentSnapingOffset+"_"+rightSnapingOffset);
        float a= Math.abs(currentSnapingOffset-leftSnapingOffset);
        if (snapingView != null) {
        ...
        if(snapingView != null && currentSnapingOffset > 0){
